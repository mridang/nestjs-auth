...
describe('RolesGuard', () => {
  ...
  describe('canActivate', () => {
    ...
    test('should allow access when empty roles array is required', () => {
      const mockContext = createMockContext(
    ...
    test('should deny access when user has no roles but roles are required', () => {
      const mockContext = createMockContext(
    ...
    test('should deny access when user has no matching roles', () => {
      const mockContext = createMockContext(
    ...
    test('should allow access when user has one of the required roles', () => {
      const mockContext = createMockContext(
        TestController.prototype.staffMethod,
        TestController,
        {
    ...
    test('should allow access when user has all required roles', () => {
      const mockContext = createMockContext(
        TestController.prototype.adminOnlyMethod,
        TestController,
        {
    ...
    test('should handle single required role', () => {
      const mockContext = createMockContext(
        TestController.prototype.adminOnlyMethod,
        TestController,
        {
    ...
    test('should deny access when user is not present in request', () => {
      const mockContext = createMockContext(
        TestController.prototype.adminOnlyMethod,
        TestController,
        {}, // No user property
