...
describe('Auth Decorators', () => {
  ...
  describe('RequireRoles decorator', () => {
    it('should set required roles metadata', () => {
  ...
  describe('AuthSession decorator logic', () => {
    ...
    it('should access user through session', () => {
      const mockUser: User = {
        id: '123',
  ...
  describe('Integration scenarios', () => {
    ...
    it('should handle complex user object structure through session', () => {
    ...
    it('should provide complete session data', () => {
      const mockUser: User = {
        id: '123',
        email: 'test@example.com',
        roles: ['user']
  ...
  describe('Decorator creation', () => {
    it('should create AuthSession decorator without errors', () => {
